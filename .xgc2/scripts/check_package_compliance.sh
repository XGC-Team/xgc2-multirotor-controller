...
grep -q "ros-\${ROS_DISTRO}-xgc2-estimator-hover-thrust-msgs (>= 1.2.0-1)" .xgc2/scripts/package_debs.sh
grep -q "ros-\${ROS_DISTRO}-xgc2-estimator-rigid-state-msgs (>= 1.2.0-1)" .xgc2/scripts/package_debs.sh
grep -q "ros-\${ROS_DISTRO}-xgc2-multirotor-reference-trajectory-msgs (>= 1.2.0-1)" .xgc2/scripts/package_debs.sh
grep -q "ros-\${ROS_DISTRO}-xgc2-px4-multirotor-controller-msgs (>= 1.2.0-1)" .xgc2/scripts/package_debs.sh
