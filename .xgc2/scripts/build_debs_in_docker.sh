...
docker run --rm \
  ...
  -v "${REPO_ROOT}:/workspace/xgc2-multirotor-controller:ro" \
  ...
  bash -lc '
    ...
    /workspace/xgc2-multirotor-controller/.xgc2/scripts/setup_xgc2_apt_source.sh
    ...
    if [[ "${INSTALL_CHECK}" == "true" ]]; then
      ...
      /workspace/xgc2-multirotor-controller/.xgc2/scripts/check_installed_packages.sh
    fi
  '
